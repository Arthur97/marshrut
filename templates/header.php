		...
		<header itemscope itemtype="http://schema.org/Thing">
			<div class="navbar navbar-fixed-top" style="overflow: hidden;">
					...
					<a class="navbar-brand hidden-xs" href="<?= htmURL ?>">
						<span itemprop="name">
							<img alt="Website logo" itemprop="image" itemprop="description" src="<?= htmDIR ?>img/logo (37x48).png" style="margin-right:5px;" />
					...
					<ul class="nav navbar-nav visible-xs">
						<li>
							<a href="<?= htmURL ?>">
								<img alt="Website logo" src="<?= htmDIR ?>img/logo (37x48).png" style="margin-top: -9px; padding-right: 7px;" />
